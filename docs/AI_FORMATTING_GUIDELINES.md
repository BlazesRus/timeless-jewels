...
**❌ Avoid These Bash-Style Commands:**
```bash
# DON'T use bash syntax
cd frontend
ls -la
cp source.json dest.json
rm file.json
echo "message"
```
...
Remember: **When in doubt, preserve the existing format and verify the version context!**

---

*This document should be referenced before making any file edits to ensure consistency and quality. For project structure details, see [📁 Project Structure](PROJECT_STRUCTURE.md).*
