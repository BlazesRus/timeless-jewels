<script>
	//From https://svelte.dev/repl/d65a4e9f0ae74d1eb1b08d13e428af32?version=3.35.0 with minor edits
    ...
    export let options = [];
	  ...
	  export let value = 'include result';
    ...
    function handleClick(event){
        ...
        value = checked === true ? 'include result' : 'exclude result'
    }
