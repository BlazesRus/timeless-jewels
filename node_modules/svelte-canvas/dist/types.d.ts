...
export type LayerEvents = 'click' | 'contextmenu' | 'dblclick' | 'auxclick' | 'mousedown' | 'mouseenter' | 'mouseleave' | 'mousemove' | 'mouseup' | 'wheel' | 'touchcancel' | 'touchend' | 'touchmove' | 'touchstart' | 'pointerenter' | 'pointerleave' | 'pointerdown' | 'pointermove' | 'pointerup' | 'pointercancel';
export type LayerEventHandler = `on${LayerEvents}`;
type CanvasEvents = LayerEvents | 'focus' | 'blur' | 'fullscreenchange' | 'fullscreenerror' | 'scroll' | 'cut' | 'copy' | 'paste' | 'keydown' | 'keypress' | 'keyup' | 'mouseover' | 'mouseout' | 'select' | 'drag' | 'dragend' | 'dragenter' | 'dragstart' | 'dragleave' | 'dragover' | 'drop' | 'pointerover' | 'pointerout' | 'gotpointercapture' | 'lostpointercapture';
